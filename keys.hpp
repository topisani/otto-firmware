...
struct Keys {
  ...
  KeyDef keys[ncols][nrows] = {
    ...
    { // Col 7
      {"BLUE CLICK", {LEDGroup::none, 0}},
      {"YELLOW CLICK", {LEDGroup::none, 0}},
      {"INVALID C7:R3", {LEDGroup::none, 0}},
      {"RED CLICK", {LEDGroup::none, 0}},
      {"INVALID C7:R5", {LEDGroup::none, 0}},
      {"INVALID C7:R6", {LEDGroup::none, 0}},
      {"GREEN CLICK", {LEDGroup::none, 0}},
      {"INVALID C7:R8", {LEDGroup::none, 0}},
    }
  };
